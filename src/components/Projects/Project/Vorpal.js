        ...
        <div className="grow-in">
            ...
            <div className="container grow-in my-5">
                ...
                <div className="row justify-content-around justify-content-lg-between bg-c-light-brown pt-4 project-container">
                    <img src={require("../../../assets/images/project-images/vorpal-image.png")} alt="A Mysterious Pixel Art Warrior" className="drop-shadow img-fluid col-10 col-lg-4 project-image mb-4 "></img>
